        ...
        <div class="row page-titles">
            <div class="col-md-8 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0 d-inline-block menu-tab">
                    <a href="/admin/vacancy" class="@if(!isset($request->active) || $request->active == '1') active-page @endif">Опубликованные вакансии</a>
                </h3>
                <h3 class="text-themecolor m-b-0 m-t-0 d-inline-block menu-tab second-tab" >
                    <a href="/admin/vacancy?active=0" class="@if($request->active == '0') active-page @endif">Неопубликованные вакансии</a>
                </h3>
                <div class="clear-float"></div>
            </div>
            <div class="col-md-4 col-4 align-self-center text-right">
                <a href="/admin/vacancy/create" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"> Добавить</a>
            </div>
        </div>
        ...
        <div class="row white-bg">
            <div style="text-align: left" class="form-group col-md-6" >
                ...
                @if($request->active == '0')
                    ...
                    <h4 class="box-title box-edit-click">
                        <a href="javascript:void(0)" onclick="isShowEnabledAll('vacancy')">Опубликовать отмеченные</a>
                    </h4>

                @else

                    <h4 class="box-title box-edit-click">
                        <a href="javascript:void(0)" onclick="isShowDisabledAll('vacancy')">Неопубликовать отмеченные</a>
                    </h4>
            ...
            <div style="text-align: right" class="form-group col-md-6" >
                <h4 class="box-title box-delete-click">
                    <a href="javascript:void(0)" onclick="deleteAll('vacancy')">Удалить отмеченные</a>
                </h4>
            </div>

            <div class="col-md-12">
                <div class="box-body">
                    <table id="vacancy_datatable" class="table table-bordered table-striped">
                        <thead>
                        <tr style="border: 1px">
                        ...
                        @foreach($row as $key => $val)
                            ...
                            <tr>
                                <td> {{ $key + 1 }}</td>
                                <td>
                                    <a target="_blank" href="{{ $val['vacancy_url_ru']}}">
                                        {{ $val['vacancy_name_ru']}}
                                    </a>
                                </td>
                                <td>
                                    <a target="_blank" href="{{ $val['vacancy_url_kz']}}">
                                        {{ $val['vacancy_name_kz']}}
                                    </a>
                                </td>
                                <td>
                                    <a target="_blank" href="{{ $val['vacancy_url_en']}}">
                                        {{ $val['vacancy_name_en']}}
                                    </a>
                                </td>
                                <td>
                                ...
                                <td style="text-align: center">
                                    <a href="javascript:void(0)" onclick="delItem(this,'{{ $val->vacancy_id }}','vacancy')">
                                        <i class="mdi mdi-delete" style="font-size: 20px; color: red;"></i>
                                    </a>
                                </td>
                                <td style="text-align: center">
                                    <a href="/admin/vacancy/{{ $val->vacancy_id }}/edit">
                                        <i class="mdi mdi-grease-pencil" style="font-size: 20px;"></i>
                                    </a>
                                </td>
                                <td style="text-align: center;">
                                    <input class="select-all" style="font-size: 15px" type="checkbox" value="{{$val->vacancy_id}}"/>
                                </td>
                            </tr>
