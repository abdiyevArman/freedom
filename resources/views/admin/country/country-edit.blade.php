    ...
    <div class="container-fluid">
        <div class="row page-titles">
            ...
            <div class="col-md-4 col-4 align-self-center text-right">
                <a href="/admin/country" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"> Назад</a>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="card-block">
                        ...
                        @if($row->country_id > 0)
                            ...
                            <form action="/admin/country" method="POST">
                                ...
                                <input type="hidden" class="image-name" id="country_image" name="country_image" value="{{ $row->country_image }}"/>
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane active" id="ru" role="tabpanel">
                                            <div class="card-block">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $row->country_name_ru }}" type="text" class="form-control" name="country_name_ru" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane " id="kz" role="tabpanel">
                                            <div class="card-block">
                                                <div class="form-group">
                                                    <label>Название</label>
                                                    <input value="{{ $row->country_name_kz }}" type="text" class="form-control" name="country_name_kz" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane " id="en" role="tabpanel">
                                            <div class="card-block">
                                                <div class="form-group">
                                                    <label>Название</label>
                                                    <input value="{{ $row->country_name_en }}" type="text" class="form-control" name="country_name_en" placeholder="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
