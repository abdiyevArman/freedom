    ...
    <div class="container-fluid">
        <div class="row page-titles">
            ...
            <div class="col-md-4 col-4 align-self-center text-right">
                <a href="/admin/team" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"> Назад</a>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <div class="card">
                    <div class="card-block">
                        ...
                        @endif
                        @if($row->team_id > 0)
                            <form action="/admin/team/{{$row->team_id}}" method="POST">
                            ...
                            <form action="/admin/team" method="POST">
                                ...
                                <input type="hidden" class="image-name" id="team_image" name="team_image" value="{{ $row->team_image }}"/>
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane active" id="ru" role="tabpanel">
                                            <div class="card-block">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $row->team_name_ru }}" type="text" class="form-control" name="team_name_ru" placeholder="">
                                                </div>
                                                <div class="form-group">
                                                    <label>Описание</label>
                                                    <textarea name="team_desc_ru" class=" form-control"><?=$row->team_desc_ru?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane " id="kz" role="tabpanel">
                                            <div class="card-block">
                                                <div class="form-group">
                                                    <label>Название</label>
                                                    <input value="{{ $row->team_name_kz }}" type="text" class="form-control" name="team_name_kz" placeholder="">
                                                </div>
                                                <div class="form-group">
                                                    <label>Описание</label>
                                                    <textarea name="team_desc_kz" class=" form-control"><?=$row->team_desc_kz?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane " id="en" role="tabpanel">
                                            <div class="card-block">
                                                <div class="form-group">
                                                    <label>Название</label>
                                                    <input value="{{ $row->team_name_en }}" type="text" class="form-control" name="team_name_en" placeholder="">
                                                </div>
                                                <div class="form-group">
                                                    <label>Описание</label>
                                                    <textarea name="team_desc_en" class=" form-control"><?=$row->team_desc_kz?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
