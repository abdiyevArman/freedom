        ...
        <div class="row page-titles">
            <div class="col-md-8 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0 d-inline-block menu-tab">
                    <a href="/admin/request-policy/kasko-express?active=1" class="@if($request->active == '1') active-page @endif">Новые</a>
                </h3>
                <h3 class="text-themecolor m-b-0 m-t-0 d-inline-block menu-tab second-tab" >
                    <a href="/admin/request-policy/kasko-express" class="@if(!isset($request->active) || $request->active == '0') active-page @endif">Прочитанные</a>
                </h3>
            ...
            <div class="col-md-4 col-4 align-self-center text-right">
                ...
                <form method="post" action="/admin/request-policy/excel/kasko-express">
                    ...
                    <table id="news_datatable" class="table table-bordered table-striped">
                        ...
                        @foreach($row as $key => $val)
                            ...
                            <tr>
                                ...
                                <td class="arial-font">
                                    <div>
                                        {{ $val->transport_number }}
                                    </div>
                                </td>
                                <td class="arial-font">
                                    <div>
                                        {{ $val->insurance_cost }}тг
                                    </div>
                                </td>
